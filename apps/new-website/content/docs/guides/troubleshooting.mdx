...
<Tabs groupId="Troubleshooting" items={['osx', 'windows']}>
  <Tab value="osx" label="Mac / Linux">
    ```bash
...
<Callout type="warn" className="border-s-pink-500 dark:border-s-pink-300 *:fill-pink-500 dark:*:fill-pink-300">
