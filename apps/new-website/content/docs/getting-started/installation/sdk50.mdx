...
{/* TODO: update info variant to use fd-primary by default so ">" syntax can be used */}
<Callout type="info" className="border-s-fd-primary *:fill-fd-primary">
...
<a href="./sdk50" className="underline underline-offset-8 text-fd-primary hover:opacity-100 p-4">SDK50+</a> 
...
{/* TODO: tip type variant directly inside the component */}
<Callout type="info" icon={<Lightbulb />} className="border-s-emerald-500 dark:border-s-emerald-300 *:stroke-emerald-500 dark:*:stroke-emerald-300">
