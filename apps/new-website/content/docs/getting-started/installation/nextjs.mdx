...
<a href="./sdk50" className="decoration-transparent hover:decoration-fd-foreground opacity-70 hover:opacity-100 underline-offset-8 rounded-lg p-4">SDK50+</a> 
...
<Tabs groupId="compiler" items={["SWC","Babel"]}>
  <Tab value="swc">
