...
<a href="./installation/" className="underline underline-offset-8 text-fd-primary hover:opacity-100 p-4">SDK50+</a> 
| <a href="./installation/sdk49" className="decoration-transparent hover:decoration-fd-foreground opacity-70 hover:opacity-100 underline-offset-8 rounded-lg p-4">SDK49</a> 
...
<include>./(other)/_tailwind.mdx</include>
