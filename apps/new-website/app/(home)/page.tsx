  ...
  return (
    <main className="flex flex-1 flex-col justify-center text-center">
      ...
      <div className="absolute -z-10 inset-0 w-full h-full [mask-image:linear-gradient(to_bottom,red,transparent_55%)]">
        <div className="-z-10 bg-gradient-to-b from-white to-cyan-600 dark:from-neutral-800 dark:to-neutral-800 rounded-full w-[55rem] h-[55rem] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 dark:blur-3xl"></div>
        <div className="bg-grid-dots rounded-full w-[55rem] h-[55rem] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"></div>
      ...
      <div className="-z-10 h-24 w-[33rem] bg-cyan-500/50 rounded-[100%] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 blur-3xl "></div>
