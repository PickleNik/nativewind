...
export default function HeroSectionVisual() {
  return (
    <div className="h-full w-full max-w-screen max-h-screen sm:max-h-[min(50vh,600px)] flex-1 flex justify-center">
      <div className="flex relative w-full justify-center">
        ...
        <div className="flex lg:flex-row flex-col items-center sm:items-end relative overflow-hidden bg-fd-background/20 p-2 rounded-2xl border backdrop-blur">
          <div className="absolute top-0 right-0 -z-10 translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full bg-fd-primary/20 blur-3xl" />
          <div className="absolute top-0 right-0 -z-10 h-full w-[32rem] bg-grid-lines-lg -skew-20 -translate-y-1/2 translate-x-1/2"/>
          ...
          <pre className="font-mono max-w-[calc(100vw-1rem)] min-h-96 relative text-start max-h-full p-4 overflow-hidden text-xs bg-fd-background/40 text-fd-foreground/50 backdrop-blur rounded-xl border [mask-image:linear-gradient(to_bottom,red,transparent)] sm:[mask-image:none]">{`...
  ...
  `}
        ...
        <div className="h-full relative min-h-96 sm:absolute sm:-right-20 sm:translate-y-1/2 lg:translate-y-0 md:right-0 w-96 rounded-t-[3rem] mx-4 mt-4 -mb-4 border-2 border-black lg:relative bg-gradient-to-b from-fd-accent/20 backdrop-blur to-white dark:to-fd-card p-8 pt-24 text-start -translate-y-1/3">
