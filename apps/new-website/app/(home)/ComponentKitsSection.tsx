    ...
    <>
      ...
      <section className="relative flex flex-col w-full max-w-fd-container mx-auto -mt-[1px] border-y border-dashed">      
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 border-t border-dashed text-left">
          ...
          <a target="_blank" href="https://rnr-docs.vercel.app/" className="p-10 flex-1 hover:bg-black/5 dark:hover:bg-cyan-400/5 duration-300 group border-r border-dashed relative">
            <div className="absolute inset-0 -z-10 bg-grid-dots-current group-hover:text-cyan-400/40 h-full w-full text-transparent duration-300" />
            <div className="-m-2 border border-dashed rounded-md backdrop-blur group-hover:rounded-xl duration-600 ease-out p-2 group-hover:border-black dark:group-hover:border-cyan-400">
          ...
          <a target="_blank" href="https://gluestack.io/" className="p-10 flex-1 hover:bg-black/5 dark:hover:bg-cyan-400/5 duration-300 group max-lg:border-r max-lg:border-t border-dashed relative">
            <div className="absolute inset-0 -z-10 bg-grid-dots-current group-hover:text-cyan-400/40 h-full w-full text-transparent duration-300" />
            <div className="-m-2 border border-dashed rounded-md backdrop-blur group-hover:rounded-xl duration-600 ease-out p-2 group-hover:border-black dark:group-hover:border-cyan-400">
