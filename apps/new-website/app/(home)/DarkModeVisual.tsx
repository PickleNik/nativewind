export default function DarkModeVisual() {
  return (
    <div className="flex flex-col justify-end p-4 gap-4 w-full h-full">
      <div className="group-hover:bg-cyan-500/30 bg-black/5 dark:bg-cyan-400/3 border border-dashed group-hover:border-cyan-400/20 duration-300 rounded-full w-10 h-10" />
