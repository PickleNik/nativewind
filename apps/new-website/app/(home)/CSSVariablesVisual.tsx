...
export default function CSSVariablesVisual() {
  return (
    <pre className="font-mono text-sm [mask-image:linear-gradient(to_bottom,red,transparent)] max-h-[calc(100%-4rem)] mt-auto overflow-y-clip group-hover:text-orange-400/60 duration-300">
      {/* TODO: highlight */}
      {`
@theme {
